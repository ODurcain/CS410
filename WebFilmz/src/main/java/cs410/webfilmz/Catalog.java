...
public class Catalog {
    ...
    public Film add(String title, String director, String genre,
        ...
        Set<Film> otherOtherFilms = byGenre.get(genre);
        if (otherOtherFilms == null) {
            otherOtherFilms = new HashSet<>();
            byGenre.put(genre, otherOtherFilms);
        }
        otherOtherFilms.add(newFilm);
        return newFilm;
    }
